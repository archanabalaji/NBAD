...
<html>
    ...
    <body>
        ...
        <div id="header">
            <nav id="header_menu">
                <ul  class="left" >
                    <li><a class="maintitle" href="UserController?action=main">Researchers Exchange Participations</a></li>
                </ul>
                <ul class="right">
                    ...
                    <c:if test="${sessionScope.theUser != null}">
                        ...
                        <li><form action="UserController?action=logout" method="Post">
                    ...
                    <c:if test="${sessionScope.theAdmin != null}">
                        <li><a href="UserController?action=about">About Us</a></li>
                        <li><a href="UserController?action=how">How it Works</a></li>
                        <li id="dropdown">Hello, ${theAdmin.name}</li>
